...
# računamo reprezentacije (embeddings) za podatke
# za svaki razred pronalazimo prosjek reprezentacija
# svaki taj prosjek reprezentacija razreda predstavlja razred, odnosno središe reprezentacije razreda.
...
# računamo reprezentaciju novog primjera
# računamo euklidsku L2 udaljenost od središta reprezentacija svakog razreda
# novi primjer se klasificira u onaj razred kojem je najbliži po euklidskoj udaljenosti
